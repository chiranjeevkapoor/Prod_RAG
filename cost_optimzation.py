...
class ModelRouter:
    ...
    def __init__(self):
        self.cheap_model = ChatGoogleGenerativeAI(model="gemini-2.5-flash-lite", api_key=os.getenv("GOOGLE_API_KEY_K"), temperature=0)

        self.expensive_model = ChatGoogleGenerativeAI(model="gemini-2.5-flash", api_key=os.getenv("GOOGLE_API_KEY_K"), temperature=0)
        self.classifier = ChatGoogleGenerativeAI(model="gemini-2.5-flash", api_key=os.getenv("GOOGLE_API_KEY_K"), temperature=0)
...
class SemanticCache:
    ...
    def __init__(self, similarity_threshold: float = 0.9):
        ...
        self.embedder = GoogleGenerativeAIEmbeddings(model="gemini-embedding-2-preview", temperature=0)
