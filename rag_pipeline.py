...
# embeddings_model.embed_query("What's our Q1 revenue?")
...
def demo_basic_rag():
    ...
    llm = ChatGoogleGenerativeAI(
        model="gemini-2.5-flash", api_key=os.getenv("GOOGLE_API_KEY_K"), temperature=0.2
    )
...
Make sure to answer in concise manner, and if you don't know the answer, just say i don't know.
"""
    )
